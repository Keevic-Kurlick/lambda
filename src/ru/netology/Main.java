...
public class Main {
    public static void main(String[] args) {
        ...
        // удобочитаемого текста. Это позволяет не вырубать программу, продолжить выполнение последующих операций.
        // Также можно было заключить в try - catch все тело метода, чтобы исключение прекращало выполнение кода
        try {
